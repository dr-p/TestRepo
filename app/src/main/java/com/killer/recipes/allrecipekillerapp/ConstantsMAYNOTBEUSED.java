...
public class ConstantsMAYNOTBEUSED {
    ...
    public static final String RECIPE_FIELD_IMAGE = "recipe_image";//recipe image
    public static final String RECIPE_FIELD_INGREDIENTS = "recipe_ingredients";//recipe ingredients
    public static final String RECIPE_FIELD_NAME = "name";//recipe name
    public static final String RECIPE_FIELD_SUMMARY = "recipe_summary";//recipe summary
    public static final String RECIPE_FIELD_STEPS = "recipe_steps";//recipe steps
    public static final String RECIPE_FIELD_TEXT = "recipe_text";
    public static final String RECIPE_FIELD_TITLE = "recipe_title";//recipe title
    ...
    static final String ACTION_START_COOKING =
            "com.recipes.manishay.recipes.START_COOKING";
